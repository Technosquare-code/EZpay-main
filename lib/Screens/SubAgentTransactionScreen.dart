...
class SubAgentTransactionScreen extends StatefulWidget {
  static const routName = "/SubAgentTransactionScreen";
  @override
  _SubAgentTransactionScreenState createState() =>
      _SubAgentTransactionScreenState();
}

class _SubAgentTransactionScreenState extends State<SubAgentTransactionScreen> {
  ...
  void didChangeDependencies() {
    agentId = ModalRoute.of(context)!.settings.arguments.toString();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: Icon(CupertinoIcons.back, color: Colors.grey),
        ),
        title: Text(
          ...
          child: Column(
            children: [
              ...
              value.transactions != null
                  ...
                  : FutureBuilder(
                      future: value.getTransactions(agentId, fromDate, toDate),
