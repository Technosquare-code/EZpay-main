...
class MobileDataScreen extends StatefulWidget {
  static const routName = "/MobileDataScreen";
  @override
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            translator.getString("MobileData.mobile"),
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.black,
                              fontFamily: "Gilroy",
                          ...
                          InputField(
                            color: Colors.white,
                            hint: translator.getString("MobileData.mobileHint"),
                            ...
                            validator: RequiredValidator(
                              errorText:
                                  "* ${translator.getString("MobileData.mobileEmpty")}!",
                            ),
                          ),
                          const SizedBox(height: 15),
                          Text(
                            translator.getString("MobileData.mobileConfirm"),
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.black,
                              fontFamily: "Gilroy",
                          ...
                          InputField(
                            color: Colors.white,
                            hint: translator
                                .getString("MobileData.mobileConfirmHint"),
                            type: TextInputType.phone,
                            errorTextColor: Colors.red,
                            ...
                            validator: (val) {
                              if (val == null || val == "") {
                                return "* ${translator.getString("MobileData.mobileConfirmEmpty")}!";
                              } else if (val != mobileController.text) {
                                return "* ${translator.getString("MobileData.mobileConfirmError")}!";
                              } else {
                                return null;
                              }
                            },
                          ...
                          const SizedBox(height: 15),
                          Text(
                            translator.getString("MobileData.network"),
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.black,
                              fontFamily: "Gilroy",
                          ...
                          MyDropdown(
                            ...
                            borderColor: Colors.grey,
                            hint:
                                translator.getString("MobileData.networkHint"),
                            ...
                            validator: (c) {
                              if (c == null) {
                                return translator
                                    .getString("MobileData.networkEmpty");
                              } else {
                                return null;
                              }
                            },
                          ...
                          if (planList.isNotEmpty)
                            Text(
                              translator.getString("MobileData.plan"),
                              style: const TextStyle(
                                fontSize: 16,
                                color: Colors.black,
                                fontFamily: "Gilroy",
                          ...
                          Text(
                            translator.getString("MobileData.amount"),
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.black,
                              fontFamily: "Gilroy",
                          ...
                          InputField(
                            color: Colors.white,
                            hint: translator.getString("MobileData.amountHint"),
                            textIcon: "\$",
                            ...
                            validator: RequiredValidator(
                              errorText:
                                  "* ${translator.getString("MobileData.amountEmpty")}!",
                            ),
                          ),
                          Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                translator.getString("MobileData.textButton"),
                                style: const TextStyle(
                                  fontSize: 16,
                                  color: Colors.white,
                                  fontFamily: "Gilroy",
